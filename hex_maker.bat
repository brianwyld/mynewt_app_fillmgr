...
:: gotta be in 'boot' not '@mcuboot' for mfg image build, sometimes doesnt put it there...
    if exist %BASE%/bin/targets/wbasev2_bootloader/app/@mcuboot/boot (
        rm -rf %BASE%/bin/targets/wbasev2_bootloader/app/boot
